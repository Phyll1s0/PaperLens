...
const RETRY_STRATEGY_ALIASES = new Map([
  ...
  ["planning", SEGMENTATION_RETRY_STRATEGIES.PLANNING_ONLY],
  ["planning-only", SEGMENTATION_RETRY_STRATEGIES.PLANNING_ONLY],
  ["snapshot", SEGMENTATION_RETRY_STRATEGIES.PLANNING_ONLY],
  ["snapshot-only", SEGMENTATION_RETRY_STRATEGIES.PLANNING_ONLY],
  ["planning-snapshot", SEGMENTATION_RETRY_STRATEGIES.PLANNING_ONLY],
