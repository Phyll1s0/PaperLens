...
export const ARTIFACT_CROP_VERSION = 10;
export const VISUAL_STRUCTURE_VERSION = 4;

const pagePixelCache = new Map();

export function enhancePagesWithVisualStructure(pages, options = {}) {
  return (pages || []).map((page) => {
    const visualRegions = inferPageVisualRegions(page, options);
    return {
      ...page,
      visualRegions,
...
export function buildArtifactCropSvg(artifact, baseUrl = "") {
